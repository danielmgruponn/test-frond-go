...
export default defineComponent({
  ...
  data() {
    return {
      mns: '',
      token: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE3MjQ5NDgwNTEsImlkIjoxLCJ1c2VybmFtZSI6InNwYXJ0YW4xMTcifQ.Z3290TiPYRQnh5Q7D2toMLD7QeRVX0F_ZEWmqjgTzTE',
